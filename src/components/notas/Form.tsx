    ...
    <div className="surface-ground px-4 py-8">
      ...
      <div className="flex flex-col justify-between items-center mb-5">
        <h1
          className={
            theme == "light"
              ? "text-900 font-bold text-3xl mb-2"
              : "text-900 font-bold text-2xl mb-2"
          }
        >
          Crear Nota
        </h1>
        <p className="text-600 mb-0">Gestion de notas de compras y ventas</p>
      </div>
      <form
      ...
      >
        <Card title="Datos Generales">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-4">
            <div>
              <label className="text-900 font-medium">Tipo de Nota</label>
              <DropdownComponent
                control={control}
                name="tipo"
          ...
          <div className="flex flex-col gap-4 md:w-1/2 lg:w-1/3 ml-auto text-lg mt-2">
            ...
            <div className="flex gap-3 justify-end mt-2 pt-4 border-t border-gray-100">
              ...
              <Button
                ...
                icon="pi pi-save"
                className="px-5 font-bold w-auto"
              />
            </div>
          </div>
        </Card>
